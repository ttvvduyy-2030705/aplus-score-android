...
const CategorySettings = ({
  ...
  const renderFixedInlineRow = useCallback(
    (
      label: string,
      data: Record<string, string | number | undefined>,
      currentItem: string | number | undefined,
      ...
      return (
        <View style={styles.fixedInlineRow}>
          <Text style={styles.fixedInlineLabel}>{label}</Text>
          <View style={styles.inlineOptions}>
            {renderButtons(label, data, currentItem, onSelect, useKey)}
          </View>
        </View>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        {renderFixedInlineRow(snookerTitle, SNOOKER, category, onSelectCategory)}
      </View>
